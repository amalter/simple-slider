 ...
 * @since 1.0.0
 */
function simple_slider_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'simple_slider-cgb-style-css', // Handle.
	...
	wp_register_script(
		'simple_slider-cgb-block-js', // Handle.
	...
	wp_register_style(
		'simple_slider-cgb-block-editor-css', // Handle.
	 ...
	 */
	register_block_type(
		'cgb/block-simple-slider', array(
			// Enqueue blocks.style.build.css on both frontend & backend.
			'style'         => 'simple_slider-cgb-style-css',
			// Enqueue blocks.build.js in the editor only.
			'editor_script' => 'simple_slider-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'simple_slider-cgb-block-editor-css',
		)
	);
}
